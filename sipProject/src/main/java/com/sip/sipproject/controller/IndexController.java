...
public class IndexController {
    ...
    @GetMapping("/sipIndex")
    public String goIndex(HttpSession httpSession) {
        Integer quantity = 1;
    ...
    @ResponseBody
    public String indexBooking2(@RequestBody RequestBooking requestBooking, HttpSession httpSession) {
        //判斷是否已經登入
    ...
    public String getIndexBooking2(Model model, HttpSession httpSession) {
        ...
        } else if (httpSession.getAttribute("requestBooking") == null) {
    ...
    public String orderDetail(@RequestParam("orderID") String orderID,HttpSession httpSession,Model model) {
        if (httpSession.getAttribute("customerLoginId") == null || orderID == null) {
            return "redirect:/customer/login";
        }
