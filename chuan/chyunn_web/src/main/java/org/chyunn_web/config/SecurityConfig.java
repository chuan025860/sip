...
import org.springframework.web.servlet.config.annotation.WebMvcConfigurer;
    ...
    //                    .addResourceLocations("file:/C:/Users/gagood72/Desktop/chuan/incident_file/");
            ...
            registry.addResourceHandler("/uploads/ckeditor_images/**")
                    .addResourceLocations("file:/\\\\192.168.2.3\\群運共用夾\\※資訊部專用\\沈世泉\\bulletin\\ckeditor_images\\");
            // 公佈欄資料夾路徑
            registry.addResourceHandler("/uploads/BulletinPost_*/**")
                    .addResourceLocations("file:/\\\\192.168.2.3\\群運共用夾\\※資訊部專用\\沈世泉\\Bulletin_file\\");
        }
        ...
        public SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
            http
                    ...
                    .authorizeHttpRequests(auth -> auth
                            ...
                            .requestMatchers("/resource_manage/**").hasAnyRole("ADMIN","BULLETIN_ADMIN")
