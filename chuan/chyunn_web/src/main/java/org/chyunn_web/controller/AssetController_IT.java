...
public class AssetController_IT {
    ...
    public ResponseEntity<Map<String, Object>> updateProperty(
            @RequestParam("final_property_id") String final_property_id,
            @RequestParam("name") String name,
            @RequestParam("category") String category,
            @RequestParam("location") String location,
            @RequestParam("custodian") String custodian,
            @RequestParam("contact_window") String contact_window,
            @RequestParam("purchase_date") String purchase_date,
            @RequestParam("purchase_amount") String purchase_amount,
            @RequestParam("tax") String tax,
            @RequestParam("supplier") String supplier,
            @RequestParam("size_serial") String size_serial,
            @RequestParam("quantity_unit") String quantity_unit,
            @RequestParam("remarks") String remarks,
            @RequestParam("change_record") String change_record,
        ...
        try {
            ...
            List<InventoryEquipmentFile> existingFiles = inventoryEquipment.getInventoryEquipmentFiles();
            ...
            if (inventoryEquipment != null) {
                ...
                String eventFolderPath = uploadDirBase + "equipment_" + inventoryEquipment.getFinal_property_id();
                ...
                if (!inventoryEquipmentFiles.isEmpty()) {
                    inventoryEquipment.getInventoryEquipmentFiles().addAll(inventoryEquipmentFiles);
                }
            }
            ...
            assetITService.insertInventoryAndFiles(inventoryEquipment,inventoryEquipment.getInventoryEquipmentFiles());
    ...
    public ResponseEntity<Map<String, Object>> addProperty(@RequestParam("name") String name,
                                                           ...
                                                           @RequestParam("management_id") String management_id,
                                                           @RequestParam("final_property_id") String final_property_id,
                                                           @RequestParam("category") String category,
                                                           @RequestParam("location") String location,
                                                           @RequestParam("custodian") String custodian,
        ...
        System.out.println(final_property_id);
        inventoryEquipment.setName(name);
        inventoryEquipment.setProperty_id(property_id);
        inventoryEquipment.setManagement_id(management_id);
        inventoryEquipment.setFinal_property_id(final_property_id);
        inventoryEquipment.setCategory(category);
        inventoryEquipment.setLocation(location);
        inventoryEquipment.setCustodian(custodian);
        inventoryEquipment.setContact_window(contact_window);
        ...
        inventoryEquipment.setRemarks(remarks);
        inventoryEquipment.setChange_record(change_record);
        if (final_property_id == null || final_property_id.trim().isEmpty()) {
            response.put("code", 400);
        ...
        try {
            Inventory_Equipment new_inventoryEquipment = assetITService.insertInventoryAndFiles(inventoryEquipment,inventoryEquipment.getInventoryEquipmentFiles());
            Inventory_EquipmentDto dto = assetITService.convertInventory_EquipmentDto(new_inventoryEquipment);
            dto.setImage_Number(String.valueOf(inventoryEquipment.getInventoryEquipmentFiles().size()));
            response.put("code", 200);
