...
public class permissionController {
    ...
    @ResponseBody
    public ResponseEntity<Map<String, Object>> update_user_post(@RequestBody CreateUserRequest req) {
        Map<String, Object> response = new HashMap<>();
    ...
    public ResponseEntity<Map<String,Object>> toggleUser(@RequestBody Map<String,String> body) {
        ...
        User u = userService.getUser(loginId);
        if (u == null) {
            return ResponseEntity
        ...
        resp.put("enabled", u.isEnabled());
        resp.put("message", u.isEnabled() ? "帳號已啟用" : "帳號已停用");
