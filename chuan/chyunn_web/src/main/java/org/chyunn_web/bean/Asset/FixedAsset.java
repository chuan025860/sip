...
@EqualsAndHashCode(exclude = {"fixedAssetFiles"})
public class FixedAsset {
    ...
    private List<FixedAssetFile> fixedAssetFiles = new ArrayList<>();

    @OneToMany(fetch = FetchType.LAZY, mappedBy = "fixedAsset", cascade = CascadeType.ALL)
    private List<FixedAssetHistory> fixedAssetHistories;  // 該設備的所有歷史紀錄
}
