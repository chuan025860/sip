...
public class Inventory_Equipment_dto {
    ...
    private Integer purchase_amount; // 購買金額
    ...
    private List<InventoryEquipmentFile_dto> inventoryEquipmentFileDtos;
}
